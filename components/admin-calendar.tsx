...
type Booking = { id: number; date: string; time: string; name: string; email: string; phone: string; status: string; service: string; barber: string; duration: number; kind?: 'booking' | 'blocker' }
type Props = { bookings: Booking[]; onEdit: (booking: Booking) => void; onCancel: (id: number) => void; onAddBlocker: (date: string, time: string) => void }
